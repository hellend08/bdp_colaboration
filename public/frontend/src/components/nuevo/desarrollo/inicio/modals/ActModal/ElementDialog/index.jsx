    ...
    >
      <Modal.Body className='px-4 container-shadow'>
        ...
        <Form onSubmit={handleSubmit(onSubmit)} className='mt-3 px-3'>
            ...
            <Input name="position" label="" textAlternative="Cargo" register={register} errors={errors} />
            <Input name="name" label="" textAlternative="Nombre" register={register} errors={errors} />
