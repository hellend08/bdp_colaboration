...
import { InicioActividadDiezSchema } from '../../../../../../../schemas/desarrollo/inicio/inicio-desa-schema';


const InicioActividadDiez = () => {

    const { register, handleSubmit, formState:{ errors } } = useForm({
        mode: 'onChange',
        resolver: yupResolver(InicioActividadDiezSchema),
        defaultValues: {
            comentarios: "",
        }
    });
...
export default InicioActividadDiez;