...
export const ActividadesEconomicas = [
    ...
    "Construcción",
    "Venta al por mayor y menos",
    "Hoteles y restaurantes",
    "Transporte, almacenamiento y comunicaciones",
    "Intermediación financiera",
    "Servicios inmobiliarios, empresariales y de alquiler",
    "Administración pública, defensa y seguridad social obligatoria SOCIAL OBLIGATORIA",
    "Educación",
...
export const areasResultado = [
    ...
    "Salud y bienestar, y seguridad alimentaria y del agua",
